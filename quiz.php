  ...
  <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
    ...
    <div class="templates" style="display:none;">
      ...
      <div class="container-fluid quiz_type-2">
        ...
        <div class="templates" style="display:none;">
          <li class="quiz_list ql-4" id="moneyheist"> <a>Money Heist</a></li>
           <li class="quiz_list ql-4"  id="strangerthings"><a>Stranger Things</a></li>
          <li class="quiz_list ql-4"  id="friends"><a>Friends</a></li>
